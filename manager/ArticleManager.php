...
class ArticleManager extends Manager
{
    ...
    {
        $sql = 'SELECT id, title, content, DATE_FORMAT(article_date, \'%d/%m/%Y\') AS article_date, DATE_FORMAT(article_edit, \'%d/%m/%Y\') AS article_edit FROM articles WHERE id = ?';
    ...
    {
        $sql = 'SELECT id, title, content, DATE_FORMAT(article_date, \'%d/%m/%Y\') AS article_date, DATE_FORMAT(article_edit, \'%d/%m/%Y\') AS article_edit FROM articles ORDER BY article_date DESC';
