...
<div class ="row">
    <div class="col-lg-12 mainpage">
        <?php 
            if ($page > 1) { ?>
                <span class="float-left"><a href="index.php?controller=home&action=getchapitre&chapitre=<?= $chapitre->getSort()-1 ?>">&laquo;Chapitre Precedent</a></span>
        <?php 
            }
        
            if ($page < $maxPage ) { ?> 
                <span class="float-right"><a href="index.php?controller=home&action=getchapitre&chapitre=<?= $chapitre->getSort()+1 ?>">Chapitre Suivant&raquo;</a></span>
        <?php 
            } ?>
